...
/**
 * The primary orchestration engine for multi-agent workflows in the Relay framework.
 *
...
public abstract class BaseAgentOrchestrator<S extends BaseAgentSession, STEP> {
     ...
     * also fails).
     *
     * <p>Override to mark the session as {@link io.relay.session.SessionStatus#FAILED},
     ...
     *
     * <p>Override this method to invoke a {@link io.relay.summary.SessionSummarizer}
