 ...
 */
package io.relay.pipeline;

import java.util.List;
import java.util.Map;

import io.relay.checkpoint.BaseChatHistoryManager;
 ...
 * ({@link io.relay.web.BaseAgentController}) and the orchestration layer. It implements a
 ...
 *       {@link io.relay.session.SessionStatus#ACTIVE} and has not exceeded the
...
public abstract class BaseAgentPipelineExecutor<S extends BaseAgentSession> {
     ...
     * to {@code emitter}.
     *
     * <p>This is the single entry point called by {@link io.relay.executor.AgentExecutor}
     ...
     * @throws IllegalStateException if the session is not {@link io.relay.session.SessionStatus#ACTIVE}
     ...
     *                               {@link io.relay.session.SessionStatus#ACTIVE}, or if the
