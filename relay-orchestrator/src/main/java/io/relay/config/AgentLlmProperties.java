 ...
 * uses them to construct the {@link io.relay.llm.ChatClientRegistry} containing the
 ...
 *
 * @see io.relay.config.ChatClientAutoConfiguration
 * @see io.relay.llm.ChatClientRegistry
 * @see io.relay.llm.ModelTier
 */
@Data
@ConfigurationProperties(prefix = "relay.llm")
public class AgentLlmProperties {

    /**
     * Base URL of the LLM gateway (or direct provider endpoint).
     * The completions path produced by the active {@link io.relay.llm.CompletionsPathStrategy}
    ...
    /**
     * Name of the default {@link io.relay.llm.LlmProvider} used when routing by
     ...
     * {@link io.relay.llm.ChatClientRegistry#getClient(io.relay.llm.LlmProvider)}.
     ...
     *
     * <p>Consumed by {@link io.relay.summary.BaseLlmSessionSummarizer} to compress
     ...
     *
     * <p>Instances of this class are converted to {@link io.relay.llm.LlmModelConfig}
    ...
    public static class ModelConfig {
         ...
         * unless a custom {@link io.relay.llm.CompletionsPathStrategy} is used.
         */
