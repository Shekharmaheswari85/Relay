...
public interface AgentExecutor<
     ...
     *
     * <p>Implementations persist a new {@link io.relay.model.BaseAgentSession} row with
     * {@link io.relay.session.SessionStatus#ACTIVE} status and return a response that
     ...
     *
     * @param status an optional {@link io.relay.session.SessionStatus} name to filter by;
    ...
    /**
     * Resumes a {@link io.relay.session.SessionStatus#PAUSED} session, returning it to
     * {@link io.relay.session.SessionStatus#ACTIVE} status.
     *
