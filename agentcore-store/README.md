...
This module defines the storage SPI that the rest of Agent Core writes against. Swap in any backend — JPA, Redis, MongoDB, DynamoDB — without touching framework code.
...
In-memory implementations ship in `src/test/java/io/agentcore/test` for use in your unit and integration tests:
