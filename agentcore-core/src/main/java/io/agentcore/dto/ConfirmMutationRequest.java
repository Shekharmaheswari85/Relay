 ...
 *   <li>The controller synthesises a confirmation signal message and runs the agent
 ...
 * {@code io.agentcore.advisor.ConfirmationGateAdvisor} and
 * {@code io.agentcore.web.BaseAgentController}.
 */
@Data
@Builder
@NoArgsConstructor
