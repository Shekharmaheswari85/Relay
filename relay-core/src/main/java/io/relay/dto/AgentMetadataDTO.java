...
/**
 * Flat DTO projection of {@link AgentMetadata} used for REST API serialization and
 * MCP tool exposure via {@code io.relay.executor.AgentExecutor#metadata()}.
 *
...
public class AgentMetadataDTO {
    ...
    /**
     * Carries the list of intents this agent recognizes, each described by an
