 ...
 * in default {@code io.relay.executor.AgentExecutor} implementations.
 *
 * <p>Extends {@link BaseAuditTrailResponse} and adds {@link #auditEvents}, a parallel
 * list of events whose {@code input} and {@code output} fields are pre-serialized to
...
public class AuditTrailResponseDTO extends BaseAuditTrailResponse {
    ...
    /**
     * Carries the list of audit events with JSON-string-serialized inputs and outputs.
     ...
     * {@link #input} and {@link #output} pre-serialized as JSON strings for
    ...
    public static class AuditEventDTO {
        ...
        /**
         * Carries the JSON-serialized string representation of the tool or LLM
