 ...
 * the serialized conversation context, and the audit timestamps needed for expiry,
...
public abstract class BaseAgentSession {
    ...
    /**
     * JSON-serialized snapshot of the full conversation context.
     * <p>
    ...
    /**
     * JSON-serialized list of tool names that are pre-approved to execute without
