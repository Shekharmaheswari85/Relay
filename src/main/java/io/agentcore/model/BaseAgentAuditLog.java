...
public abstract class BaseAgentAuditLog implements BaseAuditLog {
     ...
     * <p>
     * Matches {@code BaseAgentSession#sessionId}; stored denormalised here so that
    ...
    /**
     * JSON-serialised representation of the input supplied to the tool or LLM.
     * <p>
    ...
    /**
     * JSON-serialised representation of the result returned by the tool or LLM.
     * <p>
