 ...
 *       {@link io.agentcore.llm.ModelTier#REASONING} model; all others default to
 *       {@link io.agentcore.llm.ModelTier#UTILITY}.</li>
 *   <li>MCP session guards — {@link ToolCategory#MUTATION} tools and tools with
 *       {@link #requiresSession()} {@code = true} are wrapped by
 *       {@link io.agentcore.aspect.BaseMcpCallInterceptor} so that direct MCP calls
...
public @interface AgentTool {
     ...
     *       higher-capability {@link io.agentcore.llm.ModelTier#REASONING} model;
     *       {@link ToolCategory#DISCOVERY} and {@link ToolCategory#MONITORING} are routed to
     *       the cost-effective {@link io.agentcore.llm.ModelTier#UTILITY} model.</li>
     *   <li><b>MCP session guard</b> — {@link ToolCategory#MUTATION} tools are automatically
     *       protected by {@link io.agentcore.aspect.BaseMcpCallInterceptor}; direct MCP calls
     ...
     *
     * <p>When {@code true}, {@link io.agentcore.aspect.BaseMcpCallInterceptor} wraps the
     * tool callback and rejects any direct MCP call that arrives without a session ID bound
     * in {@link io.agentcore.session.SessionContextHolder}. This prevents the tool from
