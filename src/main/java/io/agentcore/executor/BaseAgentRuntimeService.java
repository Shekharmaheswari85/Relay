 ...
 *
 * <p>{@code BaseAgentRuntimeService} is the layer that {@link io.agentcore.web.BaseAgentController}
...
public abstract class BaseAgentRuntimeService<S extends BaseAgentSession> {
     ...
     * @param status   an optional {@link io.agentcore.session.SessionStatus} name; pass
