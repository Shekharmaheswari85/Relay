 ...
 *     private String banner;   // optional — defaults to "walmart"
 * }
 * }</pre>
 */
@Data
...
public class BaseCreateSessionRequest {
     ...
     * Called by Jackson for every unrecognised key during deserialization.
     *
     * @param key   the unrecognised JSON field name
