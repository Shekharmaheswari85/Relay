...
This module bridges Spring AI's `ChatClient` with Relay's tool, streaming, and observability infrastructure.
...
`relay-llm` includes test helpers in `src/test/java/io/relay/test`:
