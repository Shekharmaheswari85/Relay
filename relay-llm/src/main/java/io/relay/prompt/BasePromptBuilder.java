 ...
 * <p>Declare a Spring {@code @Component}, inject {@link io.relay.session.SessionContextManager}
 ...
 * }</pre>
 *
 * @param <S> the session entity type, must extend {@link io.relay.model.BaseAgentSession}
 */
@Slf4j
