 ...
 *       {@link io.relay.llm.ModelTier#REASONING} model tier because state-changing
 ...
 *       {@link io.relay.llm.ModelTier#UTILITY} tier.</li>
 *   <li><b>MCP session guard</b> — {@link #MUTATION} tools are automatically wrapped by
 *       {@link io.relay.aspect.BaseMcpCallInterceptor}, which rejects direct MCP
...
public enum ToolCategory {
     ...
     * {@link io.relay.llm.ModelTier#UTILITY} model tier.
     */
    DISCOVERY,
     ...
     * {@link io.relay.llm.ModelTier#REASONING} model tier to reduce the risk of
     * unintended actions.
     */
    MUTATION,
     ...
     * and are routed to the {@link io.relay.llm.ModelTier#UTILITY} model tier.
     */
    MONITORING
}
